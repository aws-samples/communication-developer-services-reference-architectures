...
| [Global SMS Planning Sheet](examples/Global%20SMS%20Planning%20Sheet-Public.xlsx) | `sms` `global` `planning` `reference` | A worksheet for planning global SMS rollouts across countries and use cases |
...
| [Notify Advanced Countries List](examples/notify-advanced-countries.csv) | `sms` `global` `reference` | Reference list of countries with advanced SMS notification requirements |
